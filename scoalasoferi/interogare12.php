<?php
// Interogarea simpla 7
// Afișarea username-ul fiecărui elev

    // conectarea la baza de date
    $connect = mysqli_connect("localhost", "root", "", "scoalasoferi");
    //interogarea simpla
    $query = "SELECT E.Nume, E.Prenume, U.username
    FROM Elev E INNER JOIN Users U ON E.id=U.id
...
<body>
    ...
    <form action="" method="post">
            <p style="color:white; font-family: 'Times New Roman'; font-size: 18px; text-align:center;">Username-ul fiecărui elev.</p>
