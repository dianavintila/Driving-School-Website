<?php
// Interogare simpla 2
//  Afișați mașinile după transmisie care circulă la o anumită dată (câmp variabil)

if(isset($_POST['search']))
{
    // preia valoarea din campul variabil 'tip transmisie'
    $valueToSearch = $_POST['valueToSearch'];
    // preia valoarea din campul variabil 'data sedinta
    $value = $_POST['value'];

    // interogarea simpla
    $query = "SELECT M.Marca, M.Model, M.Nr_Inmatriculare, M.Categorie
	FROM Masina M INNER JOIN Sedinta S ON M.Masina_ID=S.Masina_ID
	WHERE M.Tip_Transmisie='".$valueToSearch."' AND S.Data_Sedinta='".$value."'";
...
<body>
    ...
    <form action="" method="post">
            <p style="color:white; font-family: 'Times New Roman'; font-size: 25px; text-align:center;">Afișarea mașinilor care circulă cu aceeași transmisie la o anumită dată.</p>
            <input type="text" name="valueToSearch" placeholder="Tip Transmisie" style="border-radius: 25px; margin-left:43%; margin-top:20px; text-align:center"><br><br>
            <input type="text" name="value" placeholder="Data Sedinta" style="border-radius: 25px; margin-left:43%; margin-top:1px; text-align:center"><br><br>
