<?php 
include "config.php";
// Stergerea unei inregistrari din tabelul DOSAR

// daca variabila 'id' este setata in URL, stim ce inregistrare trebuie stearsa
if (isset($_GET['Dosar_ID'])) {
	$dosar_id = $_GET['Dosar_ID'];

	// interogarea care produce stregerea inregistrarii in functie de id
	$sql = "DELETE FROM `dosar` WHERE `Dosar_ID`='$dosar_id'";
...
<head>
  ...
  color: #313133;
  background: #4FD1C5;
  background: linear-gradient(90deg,  #FC5C7D, pink);
  border: none;
  border-radius: 1000px;
  box-shadow: 12px 12px 24px #FC5C7D;
