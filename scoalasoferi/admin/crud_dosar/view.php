<?php 
include "config.php";
// Vizualizarea tabelului Dosar 

// interogare pentru obtinerea datelor din tabelul DOSAR
$sql = "SELECT * FROM dosar";
...
<body>
	...
	<div class="container">
		<h2 style="font-weight: bold; color:white">Dosar</h2>
		<a class="highlight" href="create.php" >ADD DOSAR</a>
	<table class="table">
	<thead>
		<tr >
		<th class="column1">Data Inscriere</th>
		<th class="column2">Data Expirare</th>
		<th class="column3">Categorie Permis</th>
		<th class="column4">Total Ore</th>
		<th class="column5">Apt Medial</th>
		<th class="column6">Apt Psihologic</th>
    <th class="column7" >Certificat Cazier</th>
    <th class="column8" >Valabilitate Cazier</th>
	</tr>
	</thead>
	<tbody>	
    <?php
			...
			if ($result->num_rows > 0) {
				// vizualizarea datelor intr un tabel
				while ($row = $result->fetch_assoc()) {
		?>

					<tr>
					<td class="column1"><?php echo $row['Data_Inscriere']; ?></td>
					<td class="column2"><?php echo $row['Data_Expirare']; ?></td>
					<td class="column3"><?php echo $row['Categorie_Permis']; ?></td>
					<td class="column4"><?php echo $row['Total_Ore']; ?></td>
					<td class="column5"><?php echo $row['Apt_Medical']; ?></td>
					<td class="column6"><?php echo $row['Apt_Psihologic']; ?></td>
          <td class="column7"><?php echo $row['Certificat_Cazier']; ?></td>
          <td class="column8"><?php echo $row['Valabilitate_Cazier']; ?></td>
					<td><a class="buttonblue" href="update.php?Dosar_ID=<?php echo $row['Dosar_ID']; ?>">Edit</a>&nbsp;<a class="buttonred" href="delete.php?Dosar_ID=<?php echo $row['Dosar_ID']; ?>">Delete</a></td>
