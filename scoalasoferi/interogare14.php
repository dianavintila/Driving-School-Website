<?php
// Interogarea complexa 6
// Numărul de ore asistate ale fiecărui instructor

    // conectarea la baza de date
    $connect = mysqli_connect("localhost", "root", "", "scoalasoferi");

    // interogarea complexa
    $query="SELECT I1.Nume, I1.Prenume, (SELECT  SUM(P.Durata)
    FROM Instructor I INNER JOIN  Sedinta S ON S.Instructor_ID = I.Instructor_ID
    INNER JOIN Plata P ON P.Plata_ID=S.Plata_ID
    WHERE I.Nume=I1.Nume
    GROUP BY I.Nume, I.Prenume) AS NrOre
    FROM Instructor I1
    ORDER By NrOre DESC";
...
<body>
    ...
    <form action="" method="post">
     <p style="color:white;  font-family: 'Times New Roman'; text-align: center;font-size: 20px;">Numărul de ore asistate ale fiecărui instructor </p>
            ...
            <table style="background: #1FA2FF; 
                ...
                <tr>
                    ...
                    <td style=" text-align: center;"><?php echo $row['NrOre'];?></td>
                </tr>
                <?php endwhile;?>
            </table>
    </form>
