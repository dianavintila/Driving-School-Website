<?php
// Interogarea simpla 5
// Venituri lunare ale școlii de șoferi

    // conectarea la baza de date
    $connect = mysqli_connect("localhost", "root", "", "scoalasoferi");

    // interogarea simpla
    $query="SELECT YEAR(Data_Plata) AS An, MONTH(Data_Plata) AS Luna, SUM(Total) AS Total
    FROM plata
    GROUP BY YEAR(Data_Plata), MONTH(Data_Plata)
    ORDER BY YEAR(Data_Plata) DESC, MONTH(Data_Plata) DESC";
...
<body>
    ...
    <form action="" method="post">
            <p style="color:white; font-family: 'Times New Roman'; font-size: 20px; text-align:center;">Venituri lunare ale școlii de șoferi</p>
            ...
            <table style="background: #1FA2FF; 
                ...
                <tr>
                    ...
                    <td style=" text-align: center;"><?php echo $row['Luna'];?></td>
                    <td style=" text-align: center;"><?php echo $row['Total'];?> RON</td>
